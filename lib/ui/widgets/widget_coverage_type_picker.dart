...
import 'package:test_pj_mi/ui/widgets/widget_label.dart';
...
class CoverageTypePickerWidget extends StatefulWidget {
  final CoverageTypePickerList arguments;
  const CoverageTypePickerWidget({super.key, required this.arguments});

  @override
  State<CoverageTypePickerWidget> createState() => _CoverageTypePickerWidgetState();
}

class _CoverageTypePickerWidgetState extends State<CoverageTypePickerWidget> {
