...
class PublicBankScreen extends StatefulWidget {
  const PublicBankScreen({super.key});

  @override
  State<PublicBankScreen> createState() => _PublicBankScreenState();
}

class _PublicBankScreenState extends State<PublicBankScreen> {
  ...
  void handleSIChanged(String value) {
    ...
    // BlocProvider.of<VehicleInputFieldBloc>(context)
    //     .add(SumInsureTxtEvent(value));
  }
          ...
          children: [
            Column(
              ...
              children: [
                ...
                // ),
                // Container(
                //   child: BlocBuilder<VehicleInputFieldBloc, VehicleInputFieldState>(
                //     builder: (context, state) {
                //       if(state is SumInsureTxtState){
                //         return Text('Sum Insure is ===> ${state.sumInsureTxt.toString()}');
                //       }
                //       return Text('Text Change Data');
                //     },
                //   ),
                // ),
              ...
              NextBtnWidget(
                ...
                onNextPressed: () {
                  ...
                  if (isValid!) {
                    ...
                    // context.read<VehicleInputFieldBloc>().add(SumInsureTxtEvent(sumInsure));
