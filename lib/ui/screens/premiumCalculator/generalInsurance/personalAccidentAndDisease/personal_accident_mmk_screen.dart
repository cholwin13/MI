...
class PersonalAccidentMMKScreen extends StatefulWidget {
  const PersonalAccidentMMKScreen({super.key});

  @override
  State<PersonalAccidentMMKScreen> createState() =>
      _PersonalAccidentMMKScreenState();
}

class _PersonalAccidentMMKScreenState extends State<PersonalAccidentMMKScreen> {
  ...
  String? validateSI(value) {
    ...
    if (value!.isEmpty) {
      ...
      return '*Sum insured must be between 100,000 and 20,000,000';
    } else {
      return null;
    }
  }
          ...
          if (isValid!) {
            ...
            CustomNavigationHelper.router.push(
                ...
                extra: PremiumDetailsArguments(
                    title: 'cash_in_transit_title', isMMK: true, appBarIcon: AppImages.generalCashInSafeIcon));
          }
        },
        txt: 'next_btn_txt'.tr(),
      ),
