...
class MotorMMKPrivateCarScreen extends StatefulWidget {
  const MotorMMKPrivateCarScreen({super.key});

  @override
  State<MotorMMKPrivateCarScreen> createState() =>
      _MotorMMKPrivateCarScreenState();
}

class _MotorMMKPrivateCarScreenState extends State<MotorMMKPrivateCarScreen> {
    ...
    return Scaffold(
          ...
          children: [
            Column(
              ...
              children: [
                ...
                // BlocBuilder<VehicleInputFieldBloc, VehicleInputFieldState>(
                //   builder: (context, state) {
                //     if(state is EnginePowerTxtState){
                //       return Text('Engine Power is ===> ${state.enginePowerTxt.toString()}');
                //     }
                //     if(state is SumInsureTxtState){
                //       return Text('Sum Insure is ====> ${state.sumInsureTxt.toString()}');
                //     }
                //     return Text(
                //         'Engine Power Data ${enginePower} \n Sum Insure Data ${sumInsure}');
                //   },
                // ),
      ...
      bottomNavigationBar: NextBtnWidget(
        ...
        onNextPressed: () {
          ...
          if (isValid!) {
            enginePower = enginePowerTxtController.text;
