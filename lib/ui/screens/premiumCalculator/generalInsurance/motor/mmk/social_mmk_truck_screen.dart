...
class SocialMMKTruckScreen extends StatefulWidget {
  const SocialMMKTruckScreen({super.key});

  @override
  State<SocialMMKTruckScreen> createState() => _SocialMMKTruckScreenState();
}

class _SocialMMKTruckScreenState extends State<SocialMMKTruckScreen> {
