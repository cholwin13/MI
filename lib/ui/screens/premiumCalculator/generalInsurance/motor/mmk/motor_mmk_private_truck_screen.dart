...
class MotorMMKPrivateTruckScreen extends StatefulWidget {
  const MotorMMKPrivateTruckScreen({super.key});

  @override
  State<MotorMMKPrivateTruckScreen> createState() => _MotorMMKPrivateTruckScreenState();
}

class _MotorMMKPrivateTruckScreenState extends State<MotorMMKPrivateTruckScreen> {
