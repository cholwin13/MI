...
class MotorUSDCommercialGoodsCarryingScreen extends StatefulWidget {
  const MotorUSDCommercialGoodsCarryingScreen({super.key});

  @override
  State<MotorUSDCommercialGoodsCarryingScreen> createState() => _MotorUSDCommercialGoodsCarryingScreenState();
}

class _MotorUSDCommercialGoodsCarryingScreenState extends State<MotorUSDCommercialGoodsCarryingScreen> {
  final formKey = GlobalKey<FormState>();
  String sumInsure = '';
  String weight = '';
  String? dropDownValue;
  final sumInsureTxtController = TextEditingController();
  final weightTxtController = TextEditingController();
  bool isMMK = false;
            ...
            children: [
              Column(
                children: [
                  ...
                  const ProductInfoDetailTitleWidget(titleTxt: 'commercial_goods_carrying'),
                  Divider(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        LabelTxtInFormFieldWidget(labelTxt: 'weight'.tr()),
                        const SizedBox(
                          height: kMarginSmall,
                        ),
                        CustomTextFormFieldWidget(
                          onChanged: handleSIChanged,
                          hintTxt: 'weight_txt'.tr(),
                          textController: weightTxtController,
