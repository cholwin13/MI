...
class MotorUSDCommercialMeterTaxiScreen extends StatefulWidget {
  const MotorUSDCommercialMeterTaxiScreen({super.key});

  @override
  State<MotorUSDCommercialMeterTaxiScreen> createState() => _MotorUSDCommercialMeterTaxiScreenState();
}

class _MotorUSDCommercialMeterTaxiScreenState extends State<MotorUSDCommercialMeterTaxiScreen> {
            ...
            children: [
              Column(
                children: [
                  ...
                  const ProductInfoDetailTitleWidget(titleTxt: 'commercial_meter_taxi'),
                  Divider(
