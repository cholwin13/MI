...
class MotorUSDCommercialBusScreen extends StatefulWidget {
  const MotorUSDCommercialBusScreen({super.key});

  @override
  State<MotorUSDCommercialBusScreen> createState() => _MotorUSDCommercialBusScreenState();
}

class _MotorUSDCommercialBusScreenState extends State<MotorUSDCommercialBusScreen> {
            ...
            children: [
              Column(
                children: [
                  ...
                  const ProductInfoDetailTitleWidget(titleTxt: 'commercial_bus'),
                  Divider(
