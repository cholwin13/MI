...
class CashInSafePublicBankScreen extends StatefulWidget {
  const CashInSafePublicBankScreen({super.key});

  @override
  State<CashInSafePublicBankScreen> createState() => _CashInSafePublicBankScreenState();
}

class _CashInSafePublicBankScreenState extends State<CashInSafePublicBankScreen> {
