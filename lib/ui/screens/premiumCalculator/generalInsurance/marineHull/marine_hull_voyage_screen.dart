...
class MarineHullVoyageScreen extends StatefulWidget {
  const MarineHullVoyageScreen({super.key});

  @override
  State<MarineHullVoyageScreen> createState() => _MarineHullVoyageScreenState();
}

class _MarineHullVoyageScreenState extends State<MarineHullVoyageScreen> {
  ...
  List<AddOnList> addOnMarineHullList = [
    AddOnList(
        label: AppStrings.marineHullMalicious,
        isChecked: false,
        addOnId: 1),
    AddOnList(
        label: AppStrings.marineHullNuclear, isChecked: false, addOnId: 2),
    AddOnList(
        label: AppStrings.marineHullStrike, isChecked: false, addOnId: 3),
    AddOnList(
        label: AppStrings.marineHullWar, isChecked: false, addOnId: 4),
  ];
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                LabelTxtInFormFieldWidget(labelTxt: 'marine_hull_ship_age'.tr()),
                const SizedBox(
                  height: kMarginSmall,
                ),
                CustomTextFormFieldWidget(
...
class CoverTypeBoxWidget extends StatelessWidget {
  ...
  const CoverTypeBoxWidget({super.key, required this.coverType, this.onChanged});
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('marine_hull_select_cover_type'.tr(),
              style: TextStyle(
          ...
          //         title: Text(AppStrings.marineHullAllRisk, style: context.appFonts.bodySmall()?.copyWith(
          //           fontSize: 13.0,
          //         ),),
          //         value: '1',
          //         groupValue: coverType,
          ...
          //     Flexible(
          //       child: RadioListTile<String>(
          //         title: Text(AppStrings.marineHullTotalLossOnly, style: context.appFonts.bodySmall()?.copyWith(
          //             fontSize: 13.0
          //         ),),
          //         value: '2',
          //         groupValue: coverType,
