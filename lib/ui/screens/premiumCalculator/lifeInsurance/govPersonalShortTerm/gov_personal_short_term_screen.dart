...
class GovernmentPersonalShortTermScreen extends StatefulWidget {
  const GovernmentPersonalShortTermScreen({super.key});

  @override
  State<GovernmentPersonalShortTermScreen> createState() => _GovernmentPersonalShortTermScreenState();
}

class _GovernmentPersonalShortTermScreenState extends State<GovernmentPersonalShortTermScreen> {
          ...
          if (isValid!) {
            CustomNavigationHelper.router.push(
              ...
              //     appBarIcon: AppImages.lifeGovPersonalShortTermIcon),
                Routes.lifeGovPersonalShortTermPaymentPath.path
            );
          }
        }, txt: 'next_btn_txt'.tr(),
      ),
