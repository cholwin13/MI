...
class CriticalGroupScreen extends StatefulWidget {
  const CriticalGroupScreen({super.key});

  @override
  State<CriticalGroupScreen> createState() => _CriticalGroupScreenState();
}

class _CriticalGroupScreenState extends State<CriticalGroupScreen> {
