...
class HealthGroupScreen extends StatefulWidget {
  const HealthGroupScreen({super.key});

  @override
  State<HealthGroupScreen> createState() => _HealthGroupScreenState();
}

class _HealthGroupScreenState extends State<HealthGroupScreen> {
  ...
  final List<SelectableGridViewVO> paymentCardList = [
    SelectableGridViewVO(id: 1, title: 'quarter'.tr()),
