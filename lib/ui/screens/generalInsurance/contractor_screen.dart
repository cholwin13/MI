                  ...
                  child: Column(
                    ...
                    children: [
                      const ProductInfoDetailTitleWidget(
                        titleTxt: 'contractor_and_machinery_title',
                      ),
                      const SizedBox(
                        height: kMarginCardMedium,
                      ),
                      
                      LocalizedParagraphText(txt: 'contractor_title_desc', paddingSize: 0.0, textDecoration: TextDecoration.underline, decorationColor: context.appColors.colorPrimary,),
                      const ArrowIndicatorRowTextWidget(
                        rowParaTxt: 'contractor_purpose',
                        paddingSize: 0.0,
                      ),
                    ],
                  )),
