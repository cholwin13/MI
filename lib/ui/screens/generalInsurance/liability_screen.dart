    ...
    return Scaffold(
      appBar: AppBarWidget(
        titleIcon: Image.asset(
          AppImages.generalLiabilityIcon,
                  ...
                  child: Column(
                    ...
                    children: [
                      const ProductInfoDetailTitleWidget(
                        titleTxt: 'liability_title',
                      ),
                      const SizedBox(
                        height: kMarginCardMedium,
                      ),
                      
                      LocalizedParagraphText(txt: 'liability_title_desc', paddingSize: 0.0, textDecoration: TextDecoration.underline, decorationColor: context.appColors.colorPrimary,),
                      const ArrowIndicatorRowTextWidget(
                        rowParaTxt: 'liability_purpose',
                        paddingSize: 0.0,
                      ),
                    ],
                  )),
