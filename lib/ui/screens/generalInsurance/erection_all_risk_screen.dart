...
class ErectionAllRiskScreen extends StatelessWidget {
  const ErectionAllRiskScreen({super.key});
                  ...
                  child: const Column(
                    ...
                    children: [
                      ProductInfoDetailTitleWidget(
                        titleTxt: 'electronic_all_risk_title',
                      ),
                      SizedBox(
                        height: kMarginCardMedium,
                      ),
                      ArrowIndicatorRowTextWidget(
                        rowParaTxt: 'erection_purpose',
                        paddingSize: 0.0,
                      ),
                    ],
                  )),
