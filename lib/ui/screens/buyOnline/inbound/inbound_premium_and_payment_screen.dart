...
class InboundPremiumAndPaymentScreen extends StatelessWidget {
  const InboundPremiumAndPaymentScreen({super.key});
                        ...
                        PaymentImageWidget(
                          ...
                          onPressed: (){
                            CustomNavigationHelper.router
                                .push(Routes.inboundPaymentInfoDetailsPath.path);
                          }
                        ),
