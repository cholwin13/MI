...
class HealthInsurePersonInfo2Screen extends StatefulWidget {
  const HealthInsurePersonInfo2Screen({super.key});

  @override
  State<HealthInsurePersonInfo2Screen> createState() => _HealthInsurePersonInfo2ScreenState();
}

class _HealthInsurePersonInfo2ScreenState extends State<HealthInsurePersonInfo2Screen> {
                  ...
                  onNextPressed: () {
                    ...
                    if (isValid!) {
                      CustomNavigationHelper.router
                          .push(Routes.healthInsurePersonInfo3Path.path);
                    }
                  },
                  txt: 'next_btn_txt'.tr(),
                  buyOnlineStyle: true,
