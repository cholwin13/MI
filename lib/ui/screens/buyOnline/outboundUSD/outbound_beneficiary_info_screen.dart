...
class OutboundBeneficiaryScreen extends StatefulWidget {
  const OutboundBeneficiaryScreen({super.key});

  @override
  State<OutboundBeneficiaryScreen> createState() => _OutboundBeneficiaryScreenState();
}

class _OutboundBeneficiaryScreenState extends State<OutboundBeneficiaryScreen> {
