...
class OutboundMMKPassportInfoScreen extends StatefulWidget {
  const OutboundMMKPassportInfoScreen({super.key});

  @override
  State<OutboundMMKPassportInfoScreen> createState() => _OutboundMMKPassportInfoScreenState();
}

class _OutboundMMKPassportInfoScreenState extends State<OutboundMMKPassportInfoScreen> {
              ...
              Padding(
                ...
                child: NextBtnWidget(
                  onNextPressed: () {
                    ...
                    if (isValid!) {
                      CustomNavigationHelper.router.push(Routes.outboundMMKInsurePersonPath.path);
