...
class OutboundMMKAgentScreen extends StatefulWidget {
  const OutboundMMKAgentScreen({super.key});

  @override
  State<OutboundMMKAgentScreen> createState() => _OutboundMMKAgentScreenState();
}

class _OutboundMMKAgentScreenState extends State<OutboundMMKAgentScreen> {
              ...
              NextBtnWidget(
                onNextPressed: () {
                  CustomNavigationHelper.router
                      .push(Routes.outboundMMKPremiumAndPaymentPath.path);
                },
            ...
            if (!isCheckAgent)
              NextBtnWidget(
                onNextPressed: () {
                  ...
                  if (isValid!) {
                    if (agentLicenseNo == "1234" && dobController.text == "20-03-2024") {
                      setState(() {
                        isAgentValid = false;
                        isCheckAgent = true;
                      });
