...
class OutboundMMKInsurePersonInfoScreen extends StatefulWidget {
  const OutboundMMKInsurePersonInfoScreen({super.key});

  @override
  State<OutboundMMKInsurePersonInfoScreen> createState() => _OutboundMMKInsurePersonInfoScreenState();
}

class _OutboundMMKInsurePersonInfoScreenState extends State<OutboundMMKInsurePersonInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var packages = [
      {"label": "30,000,000 MMK", "value": 30000000},
      {"label": "90,000,000 MMK", "value": 90000000},
      {"label": "150,000,000 MMK", "value": 150000000},
    ];
                  ...
                  onNextPressed: () {
                    ...
                    if (isValid!) {
                      CustomNavigationHelper.router
                          .push(Routes.outboundMMKBeneficiaryInfoPath.path);
