...
class AirTravelProposalScreen extends StatefulWidget {
  final int id;

  const AirTravelProposalScreen({super.key, required this.id});

  @override
  State<AirTravelProposalScreen> createState() =>
      _AirTravelProposalScreenState();
}

class _AirTravelProposalScreenState extends State<AirTravelProposalScreen> {
  ...
  List<Map<String, dynamic>> idTypeList = [];
  ...
  void initState() {
    ...
    title = widget.id == 0 ? 'air_travel_domestic' : 'air_travel_oversea';
    idTypeList = [
      {"label": "NRCNO", "value": 0},
                          ...
                          onTap: () {
                            if (widget.id == 0) {
                              CustomNavigationHelper.router.push(
                                  ...
                                  extra: 'domestic_air_travel');
                            } else {
                              CustomNavigationHelper.router.push(
                                  Routes.userGuidePath.path,
                                  extra: 'oversea_air_travel');
                            }
                          },
                          child: Text(
